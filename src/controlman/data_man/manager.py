...
from controlman.data_struct import ControlCenterContent as _ControlCenterContent
...
from controlman.data_man.validator import DataValidator as _Validator
from controlman.nested_dict import NestedDict as _NestedDict


class DataManager:
    def __init__(self, data: _NestedDict):
        self._data = data
